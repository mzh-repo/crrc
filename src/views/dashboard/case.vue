          ...
          <el-row :gutter="16">
            ...
            <el-col :span="12">
              <template v-for="(item, index) in dataList.list2.operation_control">
                <case-box :key="index" :zIndex="2019 - index" :data="item" id="2" />
              </template>
            </el-col>
            <el-col :span="12">
